...
export const CURATED_RESTAURANTS: RestaurantCandidate[] = [
  ...
  },
  {
    ...
    name: "BarcelonaMilano",
    address: "Carrer de Villarroel, 190, 08036 Barcelona",
    latitude: 41.3888,
    longitude: 2.1520,
    websiteUrl: "https://restaurantbarcelonamilano.com",
    mapUrl: "https://www.google.com/maps/search/?api=1&query=BarcelonaMilano+Villarroel+190+Barcelona",
    provider: "curated",
    cuisine: "italian",
  ...
  },
  {
    ...
    name: "Sama Sama",
    address: "Carrer d'Aragó, 35-37, 43840 Salou",
    latitude: 41.0766,
    longitude: 1.1416,
    websiteUrl: "https://samasama.es",
    mapUrl: "https://www.google.com/maps/search/?api=1&query=Sama+Sama+Salou",
    provider: "curated",
    cuisine: "restaurant",
