...
const caPhrases = {
  ...
  "Showing only places with confirmed hours": "Mostrant només locals amb horari confirmat",
  ...
  "100% vegans": "vegans",
  "vegans": "vegans",
  "Top 4 Restaurants": "Top 4 Restaurants",
  "Edit": "Edita",
  "Done": "Fet",
  "Favorite restaurants": "Restaurants preferits",
  "Choose a restaurant": "Tria un restaurant",
  "Search restaurant name…": "Cerca pel nom del restaurant…",
  "No restaurants found.": "No s'han trobat restaurants.",
  "Rating distribution": "Distribució de valoracions",
  "My visit diary": "El meu diari de visites",
  "My Visit Diary": "El meu diari de visites",
  "Log a visit": "Apunta una visita",
  "Log a restaurant visit": "Apunta una visita al restaurant",
  "Log visit": "Apunta visita",
  "Visit date": "Data de la visita",
  "One log per restaurant per calendar day": "Un registre per restaurant per dia natural",
  "Dishes tried (comma separated)": "Plats que has tastat (separats per coma)",
  "Notes and review": "Notes i ressenya",
  "How was the food, service and plant-based options?": "Com ha estat el menjar, el servei i les opcions veganes?",
  "Save visit": "Desa la visita",
  "Saved!": "Desat!",
  "entry": "visita",
  "entries": "visites",
  "log": "visita",
  ...
  "visit": "visita",
  "visits": "visites",
  "Your visit diary is empty.": "El teu diari de visites és buit.",
  "Log your restaurant visits, save dishes and track your rating history over time.": "Apunta les teves visites a restaurants, desa els plats i segueix l'evolució de les teves valoracions.",
  "Explore restaurants": "Explora restaurants",
  "Delete visit": "Elimina la visita",
  "Delete entry": "Elimina l'apunt",
  "Restaurant not found": "Restaurant no trobat",
  "The requested dining spot could not be located.": "No s'ha pogut trobar el restaurant sol·licitat.",
  "Loading restaurant details…": "Carregant els detalls del restaurant…",
  "Back": "Enrere",
