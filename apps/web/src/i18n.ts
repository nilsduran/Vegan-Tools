...
const ca: Record<keyof typeof en, string> = {
  ...
  source: "Font",
  why: "Per què?",
  scanPrompt: "Enfoca la càmera cap a un codi EAN o UPC.",
...
const caPhrases: Record<string, string> = {
  ...
  "Restaurant name or name + city": "Nom del restaurant o nom + ciutat",
  ...
  "Use your camera to scan an EAN or UPC barcode.": "Utilitza la càmera per escanejar un codi EAN o UPC.",
